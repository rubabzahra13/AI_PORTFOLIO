...
const ROLES = [
  { title: 'Lead Agentic AI Engineer & Full-Stack Developer', company: 'BrandScaling (UK)', period: 'Jul 2025, Present', line: 'Agentic AI, Psychology-Driven Decision Intelligence Agent, automation.', accent: 'bg-orange-400' },
  { title: 'Lead Full-Stack Developer', company: 'Adminless (UK)', period: 'Dec 2025, Present', line: 'Care Property Hub, 11 days. GHL CRM, dashboards.', accent: 'bg-violet-400' },
