    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute inset-0 hero-bg-zoom">
          <Image
            src="/images/me/photo-1442458017215-285b83f65851.webp"
            alt=""
            fill
      ...
      <div className="absolute inset-0 z-[1] bg-[#0a0a10]/85" aria-hidden />

      {/* Subtle floating orbs in hero */}
      <div className="absolute inset-0 z-[2] pointer-events-none overflow-hidden" aria-hidden>
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-orange-500/10 blur-[100px] animate-pulse" />
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 sm:gap-10 lg:gap-16">
          ...
          <div className="order-3 lg:order-1 text-center lg:text-left lg:max-w-xl min-w-0 pt-12 sm:pt-16 lg:pt-0 relative z-10">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 hero-entrance hero-entrance-delay-4">
              <a
                href="#projects"
                className="hero-cta-primary inline-flex items-center justify-center rounded-lg border border-zinc-500 bg-white text-[#0f0f14] px-6 py-3 text-sm font-semibold hover:bg-zinc-100 w-full sm:w-auto"
              >
                View my work
              </a>
              <a
                ...
                className="hero-cta-secondary inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-500 bg-transparent text-white px-6 py-3 text-sm font-semibold hover:bg-white/5 transition-all duration-300 w-full sm:w-auto"
              >
